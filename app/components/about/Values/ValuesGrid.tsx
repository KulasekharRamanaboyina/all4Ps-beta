...
function ValueCard({ icon: Icon, title, desc, delay }: ValueCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group relative bg-[#0a0a0f]/60 backdrop-blur-md border border-brand-purple/15 rounded-xl p-5 sm:p-6 hover:border-brand-purple/40 transition-all duration-500 overflow-hidden shadow-2xl cursor-default"
    ...
    >
      ...
      <div
        ...
        style={{
          background: `radial-gradient(185px circle at ${coords.x}px ${coords.y}px, rgba(168, 85, 247, 0.18), transparent 80%)`,
        }}
      />
