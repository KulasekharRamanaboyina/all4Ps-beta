...
const FEATURE_DESCRIPTIONS: Record<string, string> = {
  "Competitor Intelligence Analysis":
    "Deep analysis of competitor GTM activities, traffic sources, messaging strategies, and market positioning.",
  "Brand Positioning Roadmap":
    "A strategic layout mapping out your target positioning, messaging pillars, and core brand channels for growth.",
  "Ideal Customer ICP Definition":
    "Identifying your highest-value buyers, account size thresholds, and decision-maker roles.",
  "Market Opportunity Mapping":
    "Uncovering white-space opportunities, underserved verticals, and competitor market vulnerabilities.",
  "Core Message Hierarchy":
    "Developing primary, secondary, and tertiary value statements customized for various buying personas and stakeholders.",
  "Technical Pitch Alignment":
    "Translating complex technical product architectures into business value pitches that close enterprise deals.",
  "Buyer Persona Playbooks":
    "Mapping specific buyer triggers, product misconceptions, and proof requirements for different roles.",
  "Sales Conversation Guides":
    "Equipping your account executives with objection handling, discovery questions, and value-pacing scripts.",
  "Executive Narrative Building":
    "Crafting custom editorial blueprints, target topics, and unique perspectives for founders and executives.",
  "PR & Placement Support":
    "Targeting high-impact trade journals, industry blogs, and podcasts to expand organic brand reach.",
  "LinkedIn Platform Domination":
    "Optimizing personal brands, scheduling calendars, and scaling executive visibility on LinkedIn.",
  "Keynote & Event Briefing":
    "Drafting high-impact presentations, slides, and talk tracks for key industry conferences.",
  "Expert-Driven Content Creation":
    "Writing research-backed whitepapers, blogs, and case studies guided by subject matter interviews.",
  "Funnel Asset Library Construction":
    "Designing downloadable resources and interactive tools to nurture leads throughout their evaluation journey.",
  "Technical Case Study Production":
    "Developing quantitative B2B case studies highlighting problem, solution architecture, and outcomes.",
  "Multi-Channel Distribution Strategy":
    "Syndicating top content assets through organic communities, dark social, and targeted paid promotion.",
  "Inbound Lead Acquisition Engine":
    "Setting up predictable lead generation setups using targeted search traffic, content gates, and landing pages.",
  "Multi-Channel Program Scaling":
    "Expanding successful campaigns across channels (LinkedIn, Google Search, retargeting) to grow inbound pipeline.",
  "Paid Retargeting Architecture":
    "Building warm audiences, retargeting funnels, and sequence ads across LinkedIn, Meta, and Google.",
  "High-Converting Landing Page Design":
    "Crafting optimized pages with persuasive copywriting, clean visual hierarchies, and clear call-to-actions.",
  "High-Value Target Mapping":
    "Researching and compiling high-value accounts, key buying groups, and localized triggers for precision outreach.",
  "Multi-Touch Sales Sequence Playbooks":
    "Coordinating outbound sales emails, cold calls, and ad campaigns for target account groups.",
  "Tier 1 Personalized Landing Pages":
    "Designing bespoke landing page structures targeted specifically at Tier 1 target accounts.",
  "ABM Orchestration & Reporting":
    "Tracking account engagement signals, intent metrics, and collaborative sales outreach loops.",
  "Paid Social & Search Execution":
    "Running performance campaigns on LinkedIn and Google Ads with bid optimization and creative testing.",
  "Lead Nurture Flow Operations":
    "Setting up automated follow-ups, newsletters, and email drips to maintain prospect engagement.",
  "A/B Creative Experimentation":
    "Testing ad messaging hooks, layout styles, and formats (video vs. static) to lower cost per click.",
  "Budget Optimization & Allocation":
    "Managing budgets across channels to maximize pipeline conversions and ad spend efficiency.",
  "Tech Stack Synchronization":
    "Aligning CRMs (HubSpot, Salesforce), tracking pixels, enrichment tools, and calendar integrations.",
  "Behavior-Triggered Lead Scoring":
    "Tracking visitor page views, downloads, and form submissions to automatically score hot leads.",
  "CRM Lifecycle Mapping":
    "Configuring pipeline stages, deal criteria, closed-won reasons, and sales handoff loops.",
  "Automated Sequence Implementation":
    "Building automated email drips, task triggers, and alerts that keep sales cycles moving forward.",
  "High-Intent Keyword Dominance":
    "Structuring organic articles and keywords that capture buyers at the precise moment they evaluate solutions.",
  "Technical Search Architecture Optimization":
    "Optimizing page load speed, mobile UX, indexation rules, and structured schema markup.",
  "Authority Backlink Acquisition":
    "Securing backlinks from respected, high-domain industry blogs and editorial sites.",
  "Organic CTR Enhancement Audits":
    "Improving title tags, meta descriptions, and schema templates to capture more search result clicks.",
  "Conversion Rate Optimisation (CRO)":
    "Running A/B tests on headline messaging, form structure, layout designs, and CTAs to boost sales call booking rates.",
  "Interactive UX/UI Refining":
    "Polishing layout visual style, scroll behaviors, load speeds, and navigation links to reduce friction.",
  "Page Speed & Core Web Vitals Optimization":
    "Optimizing JavaScript files, layouts, and image sizes to satisfy Google's ranking performance metrics.",
  "Form Friction & Drop-Off Analysis":
    "Auditing contact and sign-up forms using heatmaps to remove unnecessary input fields and boost conversions.",
  "GA4 & Attribution Configuration":
    "Configuring Google Analytics 4, Tag Manager, custom event triggers, and funnel tracking.",
  "Custom Pipeline Dashboards":
    "Building real-time executive reports that display cost-per-lead, pipeline sourced, and channel ROI.",
  "Multi-Touch Revenue Attribution Modeling":
    "Setting up attribution rules to identify which marketing touches influence closed-won deals.",
  "Pipeline Bottleneck Diagnostics":
    "Analyzing conversion rates between pipeline stages to locate friction points in your sales funnels.",
  "Product GTM Roadmap Playbooks":
    "Structuring packaging, launch pricing models, core messaging, and channels for new product launches.",
  "Market Penetration Programs":
    "Expanding successful strategies into new international regions, customer segments, or business verticals.",
  "Alpha/Beta Launch Management":
    "Coordinating pilot programs, feedback loops, and early-adopter user groups for new product entries.",
  "Sales Team Enablement Toolkits":
    "Building competitive battle cards, product FAQs, and sales sheets to help reps close new business.",
};

const DETAILED_OVERVIEWS: Record<string, string> = {
  "brand-strategy":
    "Our brand strategy process uncovers your unique value, aligns your messaging with customer needs, and creates a clear market position that helps your business scale with confidence.",
  "positioning-messaging":
    "We help B2B technology companies transform complex ideas into compelling messaging through value proposition development, audience insights, and positioning. The result is consistent communication that builds trust and supports every stage of the buyer journey.",
  "thought-leadership":
    "We create executive narratives, technical content, and industry visibility strategies that showcase your expertise. The result is stronger market authority, greater audience engagement, and increased trust among B2B decision-makers.",
  "content-marketing":
  ...
  "marketing-automation":
    "We build automated lead nurturing workflows, integrate your CRM, and streamline marketing processes to improve lead quality, increase operational efficiency, and help your team focus on high-value opportunities.",
  "seo-visibility":
    "We build SEO strategies that improve your website's technical performance, strengthen search visibility, and attract qualified B2B buyers. From technical SEO to content strategy, every optimization is designed to support long-term organic growth.",
  "website-optimisation":
    "We improve website performance, optimize landing pages, and enhance user experience to create a faster, more engaging website that converts visitors into qualified business opportunities.",
  "analytics-reporting":
...
const STAGES_DETAILS = [
  {
    stage: "Phase 1: Audit & Discovery",
    action:
      "Auditing competitor assets, performance data, and mapping buyer groups.",
  },
  {
    stage: "Phase 2: Platform Integration",
    action:
      "Setting up tracking pixels, conversion actions, and landing page layouts.",
  },
  {
    stage: "Phase 3: Program Execution",
    action:
      "Launching high-value content resources and targeting conversion campaigns.",
  },
  {
    stage: "Phase 4: Optimization & Scale",
    action: "Reviewing CTR benchmarks, lead flows, and tuning bidding budgets.",
  },
];
...
export default function ServiceDetailsSection({
  ...
  const detailedContent =
    DETAILED_OVERVIEWS[service.id] ||
    "We build strategy-led programs designed to align key messaging, accelerate pipelines, and scale commercial channels with certainty.";
          ...
          <div className="border-t border-white/5 pt-16">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-4 lg:sticky lg:top-24 space-y-6 text-left">
                ...
                <p className="text-gray-400 text-sm sm:text-base leading-relaxed">
                  Develop a strategic brand foundation that enables your
                  business to stand out, earn trust, and scale with confidence.
                </p>
                      ...
                      return (
                        ...
                        >
                          <div className="flex flex-col items-center mt-1">
                            <div
                              className={`w-2.5 h-2.5 rounded-full border transition-all duration-300 ${isActive ? "bg-fuchsia-400 border-fuchsia-400 shadow-[0_0_8px_rgba(217,70,239,0.6)]" : "bg-transparent border-white/30"}`}
                            />
                            {idx < 3 && (
                          ...
                          <div className="space-y-0.5">
                            <p
                              className={`text-xs font-bold transition-colors duration-300 ${isActive ? "text-fuchsia-400" : "text-white"}`}
                            >
                              {detail.stage}
                            </p>
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-xs sm:text-sm text-gray-400 leading-relaxed">
                              {FEATURE_DESCRIPTIONS[feature] ||
                                "Research your business, audience, and competitors to create a strong strategic foundation."}
                            </p>
                          </div>
                        </div>
                      </motion.div>
