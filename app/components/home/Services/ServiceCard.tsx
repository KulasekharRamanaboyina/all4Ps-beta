...
export default function ServiceCard({ service }: ServiceCardProps) {
  ...
  return (
    ...
    // >
    <div className="group">
      <div className=" relative flex flex-col overflow-hidden rounded-2xl border border-white/10 bg-[#0B0813] p-8 h-[260px] md:h-[250px] lg:h-[260px] hover:h-[510px] md:hover:h-[500px] lg:hover:h-[510px] transition-all duration-700 ease-out hover:shadow-[0_20px_60px_rgba(168,85,247,.15)] hover:-translate-y-2">
